...
# 0 = straight Key, 1 = iambic ModeA, 2 = iambic ModeB. Для правильного самоконтроля телеграфа должна быть включена функция Fast Sound.
# Режим iambic ModeB - при отпускании одновременно замкнутых контактов Dot и Dash во время передачи тире будет автоматически сформирована дополнительная точка.
# Подробнее читать - http://www.palm-radio.de/pdf/IambicPaddleModeAorBfunction-1.pdf.
#mode_cw = 0
mode_cw = 1
#mode_cw = 2
...
# 0 = No, 1 = Spacing, 2 = Reverse, 3 = Spacing + Reverse. В режиме Spasing, если во время манипуляции сделать паузу более чем длительность точки,
